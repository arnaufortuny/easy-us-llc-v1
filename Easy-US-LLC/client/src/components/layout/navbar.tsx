          ...
          <div className="flex flex-col flex-grow bg-white p-6 justify-start pt-8">
            <div className="flex flex-col gap-0.5">
              ...
              <div className="mt-8 px-3 flex flex-col gap-3">
                ...
                >
                  <Button 
                    className="w-full bg-[#25D366] hover:bg-[#22c35e] text-white font-black border-0 rounded-xl h-14 text-lg shadow-lg active:scale-95 transition-all flex items-center justify-center gap-3 group"
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start leading-tight">
                      <span className="text-[10px] opacity-80 font-bold uppercase tracking-wider">¿Tienes dudas?</span>
