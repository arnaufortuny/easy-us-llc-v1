      ...
      <main className="pt-20 md:pt-24 pb-12 md:pb-16 px-4 sm:px-6 flex flex-col items-center justify-center min-h-[80vh]">
        <div className="w-full max-w-sm md:max-w-md lg:max-w-4xl xl:max-w-5xl">
          <div className="lg:grid lg:grid-cols-2 lg:gap-12 xl:gap-16 lg:items-center">
            <div>
              <div className="text-center lg:text-left mb-6 md:mb-8 flex flex-col items-center lg:items-start justify-center w-full">
                ...
                <p className="text-muted-foreground mt-2 text-sm md:text-base text-center lg:text-left max-w-xs md:max-w-sm">{t("auth.login.subtitle")}</p>
              </div>
                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 md:space-y-5">
                    ...
                    <div className="relative">
                      ...
                      <Button
                        ...
                        className="absolute right-3 bottom-[6px] h-8 w-8 text-muted-foreground"
