            ...
            <div className="space-y-6">
              <div>
                ...
                <Input value={verificationCode}
                  ...
                  className="h-12 text-center text-2xl font-black border-2 border-gray-200 dark:border-border focus:border-accent tracking-[0.5em] bg-white dark:bg-[#112B1E] rounded-full"
                  maxLength={6}
                  inputMode="numeric"
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 md:space-y-5">
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              ...
                              className="h-11 md:h-12 px-5 border-2 border-gray-200 dark:border-[#1a3a2a] focus:border-accent bg-white dark:bg-[#112B1E] transition-colors font-medium text-foreground dark:text-white text-base placeholder:text-muted-foreground rounded-full"
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <select
                              {...field}
                              className="w-full rounded-full h-11 md:h-12 px-5 border-2 border-gray-200 dark:border-[#1a3a2a] focus:border-accent bg-white dark:bg-[#112B1E] transition-colors font-medium text-foreground text-base appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-accent/20"
                          ...
                          <FormControl>
                            <div className="relative">
                              <Input
                                ...
                                className="h-11 md:h-12 px-5 pr-12 border-2 border-gray-200 dark:border-[#1a3a2a] focus:border-accent bg-white dark:bg-[#112B1E] transition-colors font-medium text-foreground dark:text-white text-base placeholder:text-muted-foreground rounded-full"
                                style={{ fontFamily: 'Inter, system-ui, sans-serif', fontSize: '16px' }}
                ...
                {step === 5 && (
                  <div key="step-5" className="space-y-4">
                    ...
                    <div className="space-y-4 p-4 bg-gray-50 dark:bg-[#112B1E] rounded-2xl">
                    ...
                    <div className="p-4 bg-accent/5 border border-accent/20 rounded-2xl" data-testid="section-language-selector">
                      <div className="flex items-center gap-2 mb-3">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-testid="icon-language-globe">
                          <circle cx="12" cy="12" r="9" stroke="#00C48C" strokeWidth="1.6"/>
                          <ellipse cx="12" cy="12" rx="4" ry="9" stroke="#00C48C" strokeWidth="1.6"/>
                          <path d="M3 12H21" stroke="#00C48C" strokeWidth="1.6"/>
                          <path d="M5 8C7.5 9.5 16.5 9.5 19 8" stroke="#00C48C" strokeWidth="1.6" strokeLinecap="round"/>
                          <path d="M5 16C7.5 14.5 16.5 14.5 19 16" stroke="#00C48C" strokeWidth="1.6" strokeLinecap="round"/>
                        </svg>
