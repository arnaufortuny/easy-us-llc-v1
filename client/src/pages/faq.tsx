...
export default function FAQ() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans text-left w-full relative animate-page-in">
      ...
      <section className="pt-10 sm:pt-16 lg:pt-20 pb-4 sm:py-20 bg-background">
        <div className="container max-w-7xl mx-auto px-5 sm:px-8">
          <div className="text-center mb-8 sm:mb-12 flex flex-col items-center justify-center">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-center leading-[1.1] max-w-3xl uppercase">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-8 sm:mb-12 relative">
              ...
              />
              <div className="absolute left-3.5 sm:left-5 top-1/2 -translate-y-1/2 text-[#4A8BC2]">
                        ...
                        >
                          ...
                          >
                            ...
                            <span className={`text-xl sm:text-2xl shrink-0 ${
                              openItems[category.key] === i ? "rotate-45 text-[#4A8BC2]" : "text-primary/30"
                            }`}>
                              +
                            </span>
                          </button>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-2xl mx-auto">
            <div className="bg-accent/10 border-2 border-accent/30 rounded-3xl p-8 sm:p-10 text-center">
              ...
              <Button
                asChild
                className="bg-[#25D366] text-white font-black rounded-full px-8 h-12 shadow-lg transition-colors"
