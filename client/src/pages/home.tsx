...
export default function Home() {
  ...
  return (
    <div className="min-h-screen font-sans text-left bg-white overflow-x-hidden">
      <Navbar />
      <HeroSection 
        className="flex flex-col items-center justify-center text-center pt-12 sm:pt-16 min-h-[550px] sm:min-h-[85vh]"
        showOverlay={false}
        title={
          <motion.div 
        ...
        subtitle={
          ...
          >
            <motion.p 
              className="text-[11px] sm:text-base text-brand-dark font-medium max-w-3xl mb-8 sm:mb-4 leading-relaxed text-center mx-auto px-2"
              variants={fadeIn}
            >
