...
export default function Home() {
  ...
  return (
    <div className="min-h-screen font-sans text-left bg-white overflow-x-hidden w-full relative">
      <Navbar />
      <HeroSection 
        className="flex flex-col items-center justify-center text-center pt-32 sm:pt-16 min-h-[450px] sm:min-h-[85vh] w-full"
        showOverlay={false}
        title={
          <motion.div 
        ...
        subtitle={
          ...
          >
            ...
            >
              ...
              <span className="block sm:inline font-bold mt-3">Te entregamos tu LLC en 2 días. Sin IVA. Sin Impuesto de Sociedades. Sin cuota de autónomos.</span>
            </motion.p>
