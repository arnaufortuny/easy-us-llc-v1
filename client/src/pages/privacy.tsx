            ...
            <div className="space-y-12 text-brand-dark leading-relaxed">
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h2 className="text-xl sm:text-2xl font-black text-brand-dark  tracking-tighter">1. Responsable del tratamiento</h2>
                </div>
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-black text-brand-dark  tracking-tighter">2. Datos personales objeto de tratamiento</h2>
                </div>
                <div className="space-y-4 text-sm sm:text-base">
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-black text-brand-dark  tracking-tighter">3. Finalidad del tratamiento</h2>
                </div>
                <div className="space-y-4 text-sm sm:text-base">
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-black text-brand-dark  tracking-tighter">4. Base jurídica del tratamiento</h2>
                </div>
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-black text-brand-dark  tracking-tighter">5. Conservación de los datos</h2>
                </div>
                <div className="text-sm sm:text-base space-y-4">
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-black text-brand-dark  tracking-tighter">6. Destinatarios y cesión de datos</h2>
                </div>
                <div className="text-sm sm:text-base space-y-4">
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-black text-brand-dark  tracking-tighter">8. Derechos del interesado</h2>
                </div>
                <div className="text-sm sm:text-base space-y-4">
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-black text-brand-dark  tracking-tighter">9. Seguridad y comunicaciones</h2>
                </div>
                <div className="text-sm sm:text-base space-y-4">
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-black text-brand-dark  tracking-tighter">10. Legislación aplicable</h2>
                </div>
