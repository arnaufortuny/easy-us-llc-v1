        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
            <a 
              ...
              className="flex items-center justify-center gap-4 p-5 rounded-[1.5rem] bg-[#25D366]/5 hover:bg-[#25D366]/10 transition-all group"
            >
              <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg shadow-[#25D366]/10">
              ...
              <div className="text-left">
                ...
                <p className="text-lg font-bold text-[#25D366]">+34 614 91 69 10</p>
              </div>
            </a>

            <a 
              href="mailto:info@easyusllc.com" 
              className="flex items-center justify-center gap-4 p-5 rounded-[1.5rem] bg-primary/5 hover:bg-primary/10 transition-all group"
            >
              <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-[#6EDC8A] group-hover:scale-110 transition-transform shadow-lg shadow-primary/10">
