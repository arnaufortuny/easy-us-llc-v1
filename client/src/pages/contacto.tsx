        ...
        <main className="pt-20 sm:pt-28 pb-12 px-4 flex flex-col items-center justify-center text-center max-w-3xl mx-auto">
          <div className="space-y-5 sm:space-y-6 w-full">
            ...
            {(submittedMessageId || urlTicketId || urlOrderId) && (
              <div className="bg-background dark:bg-card border-2 border-accent px-4 py-3 sm:px-6 sm:py-4 rounded-xl inline-block">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              {(submittedMessageId || urlTicketId) && !urlOrderId && (
                <p className="text-xs sm:text-sm bg-background dark:bg-card p-3 rounded-xl border border-border max-w-md mx-auto">
      ...
      <main className="pt-24 pb-16 max-w-4xl mx-auto px-5 sm:px-6 md:px-8">
        ...
        <div className="mt-24 pt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
            ...
            >
              <div className="w-12 h-12 rounded-full bg-background dark:bg-card flex items-center justify-center group-hover:scale-105 transition-transform shadow-sm">
            ...
            >
              <div className="w-12 h-12 rounded-full bg-background dark:bg-card flex items-center justify-center text-[#6EDC8A] group-hover:scale-105 transition-transform shadow-sm">
