      ...
      <main className="pt-24 pb-16 w-full max-w-4xl mx-auto px-4 md:px-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            >
              <div className="w-16 h-16 rounded-full bg-white flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg shadow-[#25D366]/10 border border-[#25D366]/20">
