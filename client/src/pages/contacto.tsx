    ...
    <div className="min-h-screen bg-background font-sans overflow-x-hidden">
      ...
      <main className="pt-24 pb-16 w-full max-w-4xl mx-auto px-4 md:px-6">
        ...
        >
          ...
          >
            <motion.h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-primary uppercase tracking-tight text-center">
              <span className="text-accent uppercase tracking-widest text-xs sm:text-sm font-black block mb-0 text-center">OTRAS VIAS DE CONTACTO</span>
              Otras vías de contacto
            </motion.h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <a 
              ...
              className="flex items-center justify-center gap-6 p-8 rounded-[2rem] bg-[#25D366]/5 hover:bg-[#25D366]/10 transition-all group"
            >
              <div className="w-16 h-16 rounded-full bg-white flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg shadow-[#25D366]/10">
              ...
              <div className="text-left">
                <p className="text-[10px] font-bold text-primary/60 uppercase tracking-widest">WhatsApp</p>
                <p className="text-xl font-bold text-[#25D366]">+34 614 91 69 10</p>
              </div>
            </a>

            <a 
              href="mailto:info@easyusllc.com" 
              className="flex items-center justify-center gap-6 p-8 rounded-[2rem] bg-primary/5 hover:bg-primary/10 transition-all group"
            >
              <div className="w-16 h-16 rounded-full bg-white flex items-center justify-center text-[#6EDC8A] group-hover:scale-110 transition-transform shadow-lg shadow-primary/10">
                <Mail className="w-10 h-10" />
              </div>
              <div className="text-left">
                <p className="text-[10px] font-bold text-primary/60 uppercase tracking-widest">Email</p>
                <p className="text-xl font-bold text-primary">info@easyusllc.com</p>
              </div>
            </a>
          </div>
        </motion.div>
