                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-end">
                    ...
                    {!isEmailVerified && (
                      <Button 
                        ...
                        className="bg-brand-lime text-brand-dark font-sans font-black rounded-full h-11 sm:h-12 px-8 hover:bg-brand-lime/90 transition-all shrink-0 w-full sm:w-auto text-[10px] sm:text-[11px] uppercase tracking-[0.25em] shadow-lg shadow-brand-lime/20"
                      >
                  ...
                  {isOtpSent && !isEmailVerified && (
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-end animate-in fade-in slide-in-from-top-2">
                      ...
                      <Button 
                        ...
                        className="bg-brand-lime text-brand-dark font-sans font-black rounded-full h-11 sm:h-12 px-10 hover:bg-brand-lime/90 transition-all shrink-0 w-full sm:w-auto text-[10px] sm:text-[11px] uppercase tracking-[0.25em] shadow-xl shadow-brand-lime/20"
                      >
                  ...
                  <div className="pt-2">
                    <Button 
                      ...
                      className={`w-full font-sans font-black rounded-full py-7 sm:py-8 text-xs sm:text-sm transition-all shadow-xl uppercase tracking-[0.25em] ${
                        isEmailVerified 
