            ...
            <div className="space-y-12 text-brand-dark leading-relaxed">
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h2 className="text-xl sm:text-2xl font-bold text-brand-dark  tracking-tighter">1. ¿Qué son las cookies?</h2>
                </div>
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-bold text-brand-dark  tracking-tighter">2. Uso de cookies en este sitio web</h2>
                </div>
                <div className="text-sm sm:text-base space-y-4">
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-bold text-brand-dark  tracking-tighter">3. Tipos de cookies utilizadas</h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-6 bg-brand-lime/5 border border-brand-lime/20 rounded-2xl">
                    <h3 className="font-bold text-brand-dark  text-xs tracking-widest mb-3 opacity-70">Necesarias</h3>
                  ...
                  <div className="p-6 bg-brand-lime/5 border border-brand-lime/20 rounded-2xl">
                    <h3 className="font-bold text-brand-dark  text-xs tracking-widest mb-3 opacity-70">Experiencia</h3>
                  ...
                  <div className="p-6 bg-brand-lime/5 border border-brand-lime/20 rounded-2xl">
                    <h3 className="font-bold text-brand-dark  text-xs tracking-widest mb-3 opacity-70">Rendimiento</h3>
                  ...
                  <div className="p-6 bg-brand-lime/5 border border-brand-lime/20 rounded-2xl">
                    <h3 className="font-bold text-brand-dark  text-xs tracking-widest mb-3 opacity-70">Externas</h3>
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-bold text-brand-dark  tracking-tighter">4. Cookies utilizadas</h2>
                </div>
                <div className="text-sm sm:text-base space-y-4">
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-bold text-brand-dark  tracking-tighter">5. Base legal</h2>
                </div>
                <div className="text-sm sm:text-base space-y-4">
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-bold text-brand-dark  tracking-tighter">6. Gestión y configuración</h2>
                </div>
                <div className="text-sm sm:text-base space-y-4">
              ...
              <section>
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-2 h-10 bg-brand-lime rounded-full" />
                  <h2 className="text-xl sm:text-2xl font-bold text-brand-dark  tracking-tighter">8. Actualización</h2>
                </div>
