                      ...
                      {orders.map((order: any) => (
                        <Card key={order.id} className="rounded-[1.5rem] md:rounded-[2rem] border-0 shadow-sm overflow-hidden hover:shadow-md transition-shadow group">
                          <CardContent className="p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                            ...
                            <div className="flex items-center justify-between md:justify-end gap-4 w-full md:w-auto pt-4 md:pt-0 border-t md:border-t-0 border-gray-100">
                              ...
                              <Button variant="ghost" className="rounded-full w-10 h-10 md:w-12 md:h-12 p-0 bg-gray-50 group-hover:bg-accent group-hover:text-primary shrink-0">
