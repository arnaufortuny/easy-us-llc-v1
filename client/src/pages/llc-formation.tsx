  ...
  return (
    <div className="min-h-screen bg-background font-sans w-full">
      ...
      <main className="pt-24 pb-16 max-w-4xl mx-auto px-4 md:px-6">
        <h1 className="text-3xl md:text-4xl font-bold  mb-8 md:mb-12 text-primary leading-tight">Constituir mi <span className="text-accent">LLC</span></h1>
        
        <Form {...form}>
          <form className="space-y-6 md:space-y-8" onSubmit={form.handleSubmit(onSubmit)}>
            {step === 0 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">1️⃣ ¿Cómo te llamas?</h2>
                ...
                <FormField control={form.control} name="ownerFullName" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-bold  text-[10px] md:text-xs tracking-widest opacity-60">Nombre completo:</FormLabel>
                ...
                <Button type="button" onClick={nextStep} className="w-full bg-accent text-primary font-bold py-7 rounded-full text-lg shadow-lg shadow-accent/20 active:scale-95 transition-all">SIGUIENTE</Button>
              </motion.div>
            )}

            {step === 1 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">2️⃣ Email de contacto</h2>
                <FormDescription>Aquí te enviaremos los avances y documentos de tu LLC</FormDescription>
                <FormField control={form.control} name="ownerEmail" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-bold  text-[10px] md:text-xs tracking-widest opacity-60">Email:</FormLabel>
                ...
                <div className="flex gap-3">
                  <Button type="button" variant="outline" onClick={prevStep} className="flex-1 rounded-full h-14 font-bold border-gray-100 active:scale-95 transition-all">ATRÁS</Button>
                  <Button type="button" onClick={nextStep} className="flex-2 bg-accent text-primary font-bold rounded-full h-14 shadow-lg shadow-accent/20 active:scale-95 transition-all">SIGUIENTE</Button>
                </div>
              </motion.div>
            )}
            ...
            {step === 2 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">3️⃣ WhatsApp (muy recomendado)</h2>
                <FormDescription>Para dudas rápidas y avisos importantes</FormDescription>
                <FormField control={form.control} name="ownerPhone" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-bold  text-[10px] md:text-xs tracking-widest opacity-60">Teléfono:</FormLabel>
            ...
            {step === 3 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">4️⃣ ¿Cómo quieres que se llame tu LLC?</h2>
                <FormDescription>Si no estás 100% seguro, no pasa nada. Lo revisamos contigo</FormDescription>
                <FormField control={form.control} name="companyName" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-bold  text-[10px] md:text-xs tracking-widest opacity-60">Nombre deseado:</FormLabel>
            ...
            {step === 4 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">5️⃣ ¿Tienes nombres alternativos? (opcional)</h2>
                ...
                <div className="space-y-4">
                  <FormField control={form.control} name="companyNameOption2" render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-bold  text-[10px] md:text-xs tracking-widest opacity-60">Nombre alternativo 1:</FormLabel>
                  ...
                  <FormField control={form.control} name="ownerNamesAlternates" render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-bold  text-[10px] md:text-xs tracking-widest opacity-60">Nombre alternativo 2:</FormLabel>
            ...
            {step === 5 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">6️⃣ Estado donde quieres crear la LLC</h2>
            ...
            {step === 6 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">7️⃣ ¿Quién será el propietario?</h2>
                    ...
                    <FormControl>
                      <div className="flex flex-col gap-3">
                        <label className="flex items-center gap-3 p-4 rounded-full border border-gray-100 bg-white hover:border-accent cursor-pointer transition-all active:scale-[0.98]">
                          ...
                          <span className="font-bold text-primary text-sm md:text-base">Solo yo</span>
                        </label>
                        <label className="flex items-center gap-3 p-4 rounded-full border border-gray-100 bg-white hover:border-accent cursor-pointer transition-all active:scale-[0.98]">
                          <input type="radio" onChange={() => field.onChange(2)} checked={field.value > 1} className="w-5 h-5 accent-accent" />
                          <span className="font-bold text-primary text-sm md:text-base">Varios socios</span>
                        </label>
                      </div>
                    </FormControl>
                  </FormItem>
                ...
                {form.watch("ownerCount") > 1 && (
                  <FormField control={form.control} name="ownerCount" render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-bold  text-[10px] md:text-xs tracking-widest opacity-60">8️⃣ Número de miembros:</FormLabel>
            ...
            {step === 7 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">9️⃣ País de residencia</h2>
                <FormField control={form.control} name="ownerCountryResidency" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-bold  text-[10px] md:text-xs tracking-widest opacity-60">País:</FormLabel>
            ...
            {step === 8 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">🔟 Dirección completa</h2>
                ...
                <FormField control={form.control} name="ownerAddress" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-bold  text-[10px] md:text-xs tracking-widest opacity-60">Dirección:</FormLabel>
            ...
            {step === 9 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">1️⃣1️⃣ Fecha de nacimiento</h2>
                <FormField control={form.control} name="ownerBirthDate" render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-bold  text-[10px] md:text-xs tracking-widest opacity-60">Fecha:</FormLabel>
            ...
            {step === 10 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">1️⃣2️⃣ Documento de identidad</h2>
                ...
                <div className="space-y-4">
                  ...
                  <FormField control={form.control} name="idDocumentUrl" render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-bold  text-[10px] md:text-xs tracking-widest opacity-60">ID del documento (opcional):</FormLabel>
            ...
            {step === 11 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">1️⃣3️⃣ ¿A qué se dedicará tu LLC?</h2>
            ...
            {step >= 12 && step <= 17 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 text-left">
                {step === 12 && (
                  <>
                    <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">1️⃣4️⃣ ¿Vas a vender online?</h2>
                ...
                {step === 13 && (
                  <>
                    <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">1️⃣5️⃣ ¿Necesitas cuenta bancaria?</h2>
                ...
                {step === 14 && (
                  <>
                    <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">1️⃣6️⃣ ¿Usarás Stripe u otra?</h2>
                ...
                {step === 15 && (
                  <>
                    <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">1️⃣7️⃣ ¿Quieres el reporte BOI?</h2>
                ...
                {step === 16 && (
                  <>
                    <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">1️⃣8️⃣ ¿Quieres Mantenimiento?</h2>
                ...
                {step === 17 && (
                  <>
                    <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">1️⃣9️⃣ ¿Algo más que debamos saber?</h2>
            ...
            {step === 18 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-8 text-left">
                <h2 className="text-xl md:text-2xl font-bold  text-primary border-b border-accent/20 pb-2 leading-tight">Revisión Final</h2>
                <div className="bg-accent/5 p-6 md:p-8 rounded-[2rem] border border-accent/20 space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs md:text-sm">
                    <p className="flex justify-between md:block"><span className="opacity-50">Nombre:</span> <span className="font-bold">{form.getValues("ownerFullName")}</span></p>
                ...
                <div className="space-y-4">
                  <h3 className="text-[10px] font-bold  text-primary tracking-widest opacity-60">✅ Consentimientos</h3>
                  <div className="space-y-3">
                    <label className="flex items-start gap-4 p-4 rounded-[2rem] border border-gray-100 bg-white hover:border-accent cursor-pointer transition-all active:scale-[0.98]">
                      ...
                      <span className="text-xs md:text-sm font-bold text-primary leading-tight">Confirmo que la información es correcta y autorizo a Easy US LLC.</span>
                    </label>
                    <label className="flex items-start gap-4 p-4 rounded-[2rem] border border-gray-100 bg-white hover:border-accent cursor-pointer transition-all active:scale-[0.98]">
                      <Checkbox required className="mt-1" />
                      <span className="text-xs md:text-sm font-bold text-primary leading-tight">Acepto los términos del servicio y el tratamiento de mis datos.</span>
                    </label>
                  </div>
                </div>

                <div className="flex flex-col gap-4 pt-4">
                  <Button type="submit" className="w-full bg-accent text-primary font-bold py-8 rounded-full text-lg md:text-xl  tracking-widest hover:scale-[1.02] active:scale-95 transition-all shadow-xl shadow-accent/20">
                    🚀 Ir al Pago
                  </Button>
                  <Button type="button" variant="ghost" onClick={() => setStep(0)} className="text-primary/50 font-bold  text-[10px] tracking-widest">Empezar de nuevo</Button>
                </div>
              </motion.div>
            )}
            ...
            {step === 20 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-8 text-center">
                ...
                <h2 className="text-2xl md:text-3xl font-bold  text-primary leading-tight">Casi listo</h2>
                ...
                <div className="bg-accent text-primary p-8 rounded-[2rem] max-w-xs mx-auto my-8">
                  <p className=" text-[10px] font-bold tracking-widest opacity-50 mb-2">Total a pagar</p>
                  <p className="text-4xl md:text-5xl font-bold mb-4">$399.00</p>
                  <p className="text-[10px] md:text-xs opacity-80 italic">Incluye tasas estatales de {form.getValues("state")}</p>
                </div>

                <Button onClick={handlePayment} className="w-full max-w-xs bg-accent text-primary font-bold py-7 rounded-full text-lg  tracking-widest hover:scale-[1.02] active:scale-95 transition-all shadow-lg shadow-accent/20">
                  💳 Pagar con Stripe
                </Button>
              </motion.div>
            )}
