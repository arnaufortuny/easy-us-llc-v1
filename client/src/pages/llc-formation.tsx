                          ...
                          <label 
                            ...
                            className={`flex items-center justify-between gap-3 px-4 py-3 rounded-full border-2 cursor-pointer transition-colors ${
                              field.value === opt.name 
                                ...
                                : 'border-gray-200 dark:border-border bg-white dark:bg-[#112B1E] hover:border-accent/50'
                            }`}
                          >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField control={form.control} name="ownerFirstName" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Input {...field} className="h-12 px-5 border-2 border-gray-200 dark:border-border focus:border-accent bg-white dark:bg-[#112B1E] transition-colors font-medium text-foreground text-base rounded-full" /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                ...
                {!isAuthenticated && (
                  <div className="space-y-4 pt-4">
                    ...
                    <Button type="button"
                      ...
                      className="w-full h-12 rounded-full border-2 border-gray-200 dark:border-border bg-white dark:bg-[#112B1E] hover:bg-gray-50 dark:hover:bg-zinc-700 transition-colors font-bold flex items-center justify-center gap-3"
                    >
              ...
              <div key={"step-" + step} className="space-y-6 text-left">
                ...
                <FormField control={form.control} name="ownerEmail" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input {...field} type="email" className="h-12 px-5 border-2 border-gray-200 dark:border-border focus:border-accent bg-white dark:bg-[#112B1E] transition-colors font-medium text-foreground text-base rounded-full" /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
                <div className="flex gap-3">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <NativeSelect 
                          ...
                          className="rounded-full h-12 px-5 border-2 border-gray-200 dark:border-border focus:border-accent bg-white dark:bg-[#112B1E] transition-colors font-medium text-foreground text-base"
                        >
              ...
              <div key={"step-" + step} className="space-y-6 text-left">
                ...
                <FormField control={form.control} name="ownerBirthDate" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input {...field} type="date" className="h-12 px-5 border-2 border-gray-200 dark:border-border focus:border-accent bg-white dark:bg-[#112B1E] transition-colors font-medium text-foreground text-base max-w-[200px] md:max-w-none rounded-full" /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
                <div className="flex gap-3">
              ...
              <div key={"step-" + step} className="space-y-8 text-left">
                ...
                {!isAuthenticated && (
                  <div className="space-y-6">
                    ...
                    {!isOtpVerified && (
                      <div className="space-y-4">
                        <div className="bg-gray-50 dark:bg-[#112B1E] rounded-2xl p-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input type={showPassword ? "text" : "password"}
                      ...
                      className="h-12 px-5 pr-12 border-2 border-gray-200 dark:border-[#1a3a2a] focus:border-accent bg-white dark:bg-[#112B1E] rounded-full font-medium text-foreground text-base"
