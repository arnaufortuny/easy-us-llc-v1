          ...
          <form className="space-y-6 md:space-y-8" onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div key="step-0" className="space-y-6 text-left">
                ...
                <FormField control={form.control} name="ownerFullName" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input {...field} className="rounded-full h-14 px-6 border-border focus:border-accent"  /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
              ...
              <div key={"step-" + step} className="space-y-6 text-left">
                ...
                <FormField control={form.control} name="ownerEmail" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input {...field} type="email" className="rounded-full h-14 px-6 border-border focus:border-accent"  /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
              ...
              <div key={"step-" + step} className="space-y-6 text-left">
                ...
                <FormField control={form.control} name="ownerCount" render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <div className="flex flex-col gap-3">
                        <label className="flex items-center gap-3 p-4 rounded-full border border-border bg-background dark:bg-card hover:border-accent cursor-pointer transition-all active:scale-[0.98]">
                ...
                {form.watch("ownerCount") > 1 && (
                  <FormField control={form.control} name="ownerCount" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Input type="number" {...field} onChange={e => field.onChange(parseInt(e.target.value))} className="rounded-full h-14 px-6 border-border focus:border-accent" min={2} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                )}
              ...
              <div key={"step-" + step} className="space-y-6 text-left">
                ...
                <FormField control={form.control} name="ownerBirthDate" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input {...field} type="date" className="rounded-full h-14 px-6 border-border focus:border-accent" /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
                <div className="flex gap-3">
            ...
            {step === 10 && (
              <div key={"step-" + step} className="space-y-6 text-left">
                ...
                <div className="space-y-4">
                  <div className="border-2 border-dashed border-border rounded-[2rem] p-8 md:p-12 text-center hover:border-accent transition-colors cursor-pointer bg-background dark:bg-card">
                  ...
                  <label className="flex items-center gap-3 p-4 rounded-[2rem] border border-border bg-background dark:bg-card hover:border-accent cursor-pointer transition-all">
                    <Checkbox 
                ...
                <FormField control={form.control} name="paymentMethod" render={({ field }) => (
                  <FormControl>
                    <div className="flex flex-col gap-4">
                      <label className={`flex items-start gap-4 p-5 rounded-2xl border-2 cursor-pointer transition-all ${field.value === 'transfer' ? 'border-accent bg-accent/5' : 'border-border bg-background dark:bg-card hover:border-accent/50'}`}>
                      ...
                      <label className={`flex items-start gap-4 p-5 rounded-2xl border-2 cursor-pointer transition-all ${field.value === 'link' ? 'border-accent bg-accent/5' : 'border-border bg-background dark:bg-card hover:border-accent/50'}`}>
              ...
              <div key={"step-" + step} className="space-y-8 text-left">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-start gap-4 p-4 rounded-[2rem] border border-border bg-background dark:bg-card hover:border-accent cursor-pointer transition-all active:scale-[0.98]">
