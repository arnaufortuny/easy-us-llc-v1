...
export default function LlcFormation() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans w-full">
      <Navbar />
      <main className="pt-20 sm:pt-20 pb-16 max-w-xl mx-auto px-4 md:px-6">
        {isEditMode && (
          ...
          <form className="space-y-6 md:space-y-8" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            {step === 5 && (
              <div key={"step-" + step} className="space-y-6 text-left">
                ...
                <div className="bg-muted/50 dark:bg-card/50 p-4 rounded-2xl border border-border">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <NativeSelect 
                          ...
                          className="rounded-full h-12 px-5 border-2 border-border dark:border-border focus:border-accent bg-white dark:bg-card transition-colors font-medium text-foreground text-base"
                        >
