...
const formSchema = z.object({
  ...
  ownerIdType: z.string().min(1, "Este campo es obligatorio"),
  ownerIdNumber: z.string().min(1, "Este campo es obligatorio"),
  ...
  businessCategory: z.string().min(1, "Este campo es obligatorio"),
                  ...
                  <div key="step-6" className="space-y-6 text-left">
                    ...
                    <FormField control={form.control} name="ownerAddress" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Textarea {...field} className="rounded-[2rem] min-h-[120px] p-6 border-border focus:border-accent transition-all font-black text-primary text-lg" data-testid="input-address" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    <div className="flex gap-3 max-w-md mx-auto">
                ...
                {step === 8 && (
                  <div key="step-8" className="space-y-6 text-left">
                    ...
                    <FormField control={form.control} name="businessActivity" render={({ field }) => (
                      <FormItem>
                        <FormControl><Textarea {...field} className="rounded-[2rem] min-h-[120px] p-6 border-border focus:border-accent transition-all font-black text-primary text-lg" data-testid="input-business-activity" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    <div className="flex gap-3 max-w-md mx-auto">
                ...
                {step === 11 && (
                  <div key="step-11" className="space-y-6 text-left">
                    ...
                    <FormField control={form.control} name="notes" render={({ field }) => (
                      <FormItem>
                        <FormControl><Textarea {...field} className="rounded-[2rem] min-h-[120px] p-6 border-border focus:border-accent transition-all font-black text-primary text-lg" data-testid="input-notes" /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    <div className="flex gap-3 max-w-md mx-auto">
