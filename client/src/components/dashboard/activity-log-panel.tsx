...
const ACTION_COLORS: Record<string, string> = {
  ...
  user_register: "bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300",
  ...
  email_verified: "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-300",
  ...
  order_created: "bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300",
  order_status_change: "bg-sky-100 text-sky-800 dark:bg-sky-900/40 dark:text-sky-300",
  order_completed: "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-300",
  order_updated: "bg-sky-100 text-sky-800 dark:bg-sky-900/40 dark:text-sky-300",
  payment_received: "bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300",
  ...
  identity_verification_approved: "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-300",
  ...
  account_unlocked: "bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300",
  ...
  backup_completed: "bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300",
    ...
    <div className="space-y-3" data-testid="admin-activity-log">
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        <NativeSelect
          ...
          className="text-xs rounded-full w-full sm:w-52"
