  ...
  "fixed z-50 gap-4 bg-background p-4 sm:p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300 touch-pan-y overscroll-contain",
  {
    variants: {
      side: {
        ...
        right:
          "top-1/2 -translate-y-1/2 right-0 max-h-[90vh] w-full sm:w-[420px] md:w-[480px] border-l rounded-l-2xl data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right overflow-y-auto",
      },
    },
    defaultVariants: {
      side: "right",
  ...
  <SheetPortal>
    ...
    >
      ...
      <SheetPrimitive.Close 
        className="absolute right-3 top-3 w-9 h-9 sm:w-8 sm:h-8 rounded-full bg-muted/80 hover:bg-muted active:bg-muted/60 flex items-center justify-center transition-colors touch-manipulation focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
