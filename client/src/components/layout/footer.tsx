      ...
      <div className="w-full px-5 sm:px-8">
        ...
        <div className="grid grid-cols-2 gap-8 md:hidden text-left mb-10">
          <div className="flex flex-col items-start">
            <h4 className="font-bold text-base uppercase tracking-wider mb-5 border-b border-white/20 pb-1 w-full">Enlaces</h4>
          ...
          <div className="flex flex-col items-start">
            <h4 className="font-bold text-base uppercase tracking-wider mb-5 border-b border-white/20 pb-1 w-full">Legal</h4>
            <nav className="flex flex-col gap-3 text-base text-primary-foreground/70">
        ...
        <div className="flex flex-col items-start md:hidden mb-12">
          <h4 className="font-bold text-base uppercase tracking-wider mb-6 border-b border-white/20 pb-1 w-full">Contáctanos</h4>
        ...
        <div className="mt-6 sm:mt-8 pt-6 border-t border-white/20 flex flex-col md:flex-row items-center justify-between gap-4 text-primary-foreground/50 text-sm sm:text-base">
