      ...
      <div className="w-full px-5 sm:px-8">
        ...
        <div className="grid grid-cols-2 gap-8 md:hidden text-left mb-10">
          <div className="flex flex-col items-start">
            <h4 className="font-black text-base  tracking-wider mb-5 border-b border-white/20 pb-1 w-full">Enlaces</h4>
        ...
        <div className="flex flex-col items-start md:hidden mb-12">
          <h4 className="font-black text-base  tracking-wider mb-6 border-b border-white/20 pb-1 w-full">Contáctanos</h4>
          <div className="flex flex-col gap-3 text-base text-primary-foreground/70 text-left">
            ...
            <a href="mailto:hola@easyusllc.com" className="hover:text-primary-foreground transition-colors">hola@easyusllc.com</a>
        ...
        <div className="hidden md:grid md:grid-cols-4 gap-10 text-left">
          ...
          <div className="flex flex-col items-start">
            <h4 className="font-black text-base  tracking-wider mb-5">Enlaces</h4>
            <nav className="flex flex-col gap-3 text-base text-primary-foreground/70">
          ...
          <div className="flex flex-col items-start">
            <h4 className="font-black text-base  tracking-wider mb-6">Contáctanos</h4>
        ...
        <div className="mt-10 sm:mt-14 pt-8 border-t border-white/20">
          <p className="text-center text-primary-foreground/50 text-sm font-black  tracking-widest mb-6">Partners</p>
