      ...
      <div className="container max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid grid-cols-2 gap-8 md:hidden text-left mb-10">
          <div className="flex flex-col items-start">
            <h4 className="font-bold text-base uppercase tracking-wider mb-5 border-b border-brand-lime/30 pb-1 w-full">Enlaces</h4>
            <nav className="flex flex-col gap-3 text-base text-white/70">
              <Link href="/" className="hover:text-white transition-colors py-1">Inicio</Link>
              <Link href="/servicios" className="hover:text-white transition-colors py-1">Servicios</Link>
              <button onClick={() => handleHashClick('/#pricing')} className="hover:text-white transition-colors py-1 text-left">Precios</button>
              <button onClick={() => handleHashClick('/#faq')} className="hover:text-white transition-colors py-1 text-left">FAQ</button>
            </nav>
          </div>
          
          <div className="flex flex-col items-start">
            <h4 className="font-bold text-base uppercase tracking-wider mb-5 border-b border-brand-lime/30 pb-1 w-full">Legal</h4>
            <nav className="flex flex-col gap-3 text-base text-white/70">
              <Link href="/legal" className="hover:text-white transition-colors py-1">Términos</Link>
              <Link href="/privacidad" className="hover:text-white transition-colors py-1">Privacidad</Link>
              <Link href="/reembolsos" className="hover:text-white transition-colors py-1">Reembolsos</Link>
        ...
        <div className="flex flex-col items-start md:hidden mb-12">
          <h4 className="font-bold text-base uppercase tracking-wider mb-6 border-b border-brand-lime/30 pb-1 w-full">Contáctanos</h4>
          <div className="flex flex-col gap-3 text-base text-white/70 text-left">
            <a href="https://wa.me/34614916910" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center gap-2">
          ...
          <a href="mailto:info@easyusllc.com" className="hover:text-white transition-colors">info@easyusllc.com</a>
        ...
        <div className="hidden md:grid md:grid-cols-4 gap-10 text-left">
          ...
          <div className="flex flex-col items-start">
            ...
            <nav className="flex flex-col gap-3 text-base text-white/70">
              <Link href="/legal" className="hover:text-white transition-colors">Términos y Condiciones</Link>
              <Link href="/privacidad" className="hover:text-white transition-colors">Política de Privacidad</Link>
              <Link href="/reembolsos" className="hover:text-white transition-colors">Política de Reembolsos</Link>
              <Link href="/cookies" className="hover:text-white transition-colors">Aviso de Cookies</Link>
            </nav>
          </div>
