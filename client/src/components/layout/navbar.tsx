    ...
    <header className="fixed top-0 left-0 right-0 z-[100] bg-background border-b border-border shadow-sm transition-shadow h-20 sm:h-24 flex items-center w-full" data-mobile-menu-open={isOpen}>
      <div className="w-full px-5 sm:px-8">
        <div className="flex items-center justify-between w-full">
          ...
          <nav className="hidden md:flex items-center gap-0.5 lg:gap-1.5 bg-accent/10 dark:bg-accent/20 rounded-full px-2 lg:px-3 h-11 border border-accent/30">
            <button onClick={() => handleNavClick("/")} onMouseEnter={() => prefetchOnHover("/")} onMouseLeave={cancelPrefetch} className="text-[11px] lg:text-sm font-bold text-foreground hover:text-accent transition-colors whitespace-nowrap px-1.5 lg:px-2 py-1 h-full flex items-center">{t("nav.home")}</button>
            <button onClick={() => handleNavClick("/servicios")} onMouseEnter={() => prefetchOnHover("/servicios")} onMouseLeave={cancelPrefetch} className="text-[11px] lg:text-sm font-bold text-foreground hover:text-accent transition-colors whitespace-nowrap px-1.5 lg:px-2 py-1 h-full flex items-center">{t("nav.services")}</button>
            <span className="text-muted-foreground/40">|</span>
            <button onClick={() => handleNavClick("/servicios#pricing")} onMouseEnter={() => prefetchOnHover("/servicios")} onMouseLeave={cancelPrefetch} className="text-[11px] lg:text-sm font-medium text-muted-foreground hover:text-accent transition-colors whitespace-nowrap px-1 lg:px-1.5 py-1 h-full flex items-center">{t("nav.pricing")}</button>
            <button onClick={() => handleNavClick("/servicios#comparador")} onMouseEnter={() => prefetchOnHover("/servicios")} onMouseLeave={cancelPrefetch} className="text-[11px] lg:text-sm font-medium text-muted-foreground hover:text-accent transition-colors whitespace-nowrap px-1 lg:px-1.5 py-1 h-full flex items-center">{t("nav.savings")}</button>
            <span className="text-muted-foreground/40">|</span>
            <button onClick={() => handleNavClick("/faq")} onMouseEnter={() => prefetchOnHover("/faq")} onMouseLeave={cancelPrefetch} className="text-[11px] lg:text-sm font-bold text-foreground hover:text-accent transition-colors whitespace-nowrap px-1.5 lg:px-2 py-1 h-full flex items-center">{t("nav.faq")}</button>
            <button 
              onClick={() => handleNavClick("/contacto")} 
              onMouseEnter={() => prefetchOnHover("/contacto")} 
              onMouseLeave={cancelPrefetch}
              className="text-[11px] lg:text-sm font-bold text-foreground hover:text-accent transition-colors whitespace-nowrap px-1.5 lg:px-2 py-1 h-full flex items-center"
            >
              {t("nav.contact")}
            </button>
            <button 
              ...
              onMouseLeave={cancelPrefetch}
              className="text-[11px] lg:text-sm font-bold text-accent hover:text-accent/80 transition-colors whitespace-nowrap px-1.5 lg:px-2 py-1 h-full flex items-center"
          ...
          <div className="hidden md:flex items-center gap-1.5 lg:gap-2.5">
            {authLoading ? (
              <Button 
                variant="outline"
                className="rounded-full border-2 border-accent text-foreground font-black text-xs lg:text-sm h-11 px-3 lg:px-5 flex items-center gap-2 opacity-50"
                disabled
              >
              ...
              <div className="flex items-center gap-2">
                <Link href="/dashboard">
                  <Button 
                    variant="outline"
                    className="rounded-full border-2 border-accent text-foreground font-black text-xs lg:text-sm h-11 px-3 lg:px-5 flex items-center gap-2"
            ...
            {!authLoading && !isAuthenticated && (
              <Button 
                ...
                className="bg-accent text-accent-foreground font-black text-xs lg:text-sm border-0 rounded-full h-11 px-4 lg:px-6 shadow-md"
                variant="default"
              >
                {t("nav.register")}
              </Button>
              ...
              <div className="mt-4 px-3 flex flex-col gap-3">
                {!isAuthenticated && (
                  <Button 
                    ...
                    className="w-full bg-accent text-white font-black text-sm h-12 shadow-lg flex items-center justify-center gap-2 rounded-full"
                  >
                    {t("nav.register")} →
                  </Button>
                )}
                ...
                >
                  <Button 
                    className="w-full bg-secondary text-foreground font-black text-sm h-12 shadow-lg flex items-center justify-center gap-2 border-2 border-accent rounded-full"
                  >
