      ...
      <div className="w-full px-4 sm:px-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 shrink-0 relative z-[110]" onClick={() => { setIsOpen(false); window.scrollTo(0, 0); }} data-testid="link-logo">
            <img src={logoIcon} alt="Easy US LLC" className="w-14 h-14 sm:w-16 sm:h-16 object-contain" />
          </Link>
          ...
          <div className="flex flex-col flex-grow bg-white p-6 justify-start pt-24">
            <div className="flex flex-col gap-0.5">
              ...
              <div className="mt-8 px-3 flex flex-col gap-3">
                ...
                >
                  <Button 
                    className="w-full bg-brand-lime text-brand-dark font-black text-sm h-12 shadow-lg active:scale-95 transition-transform flex items-center justify-center gap-2"
