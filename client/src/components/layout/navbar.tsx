      ...
      <div className="w-full px-5 sm:px-8">
        <div className="flex items-center justify-between w-full">
          ...
          <nav className="hidden md:flex items-center gap-6 lg:gap-8">
            <button onClick={() => handleNavClick("/")} className="text-base font-bold text-foreground hover:text-accent transition-colors">Inicio</button>
            <button onClick={() => handleNavClick("/servicios")} className="text-base font-bold text-foreground hover:text-accent transition-colors">Nuestros Servicios</button>
          ...
          <Button 
            ...
            className="hidden md:inline-flex bg-accent text-accent-foreground font-bold text-sm border-0 rounded-full h-12 px-8 hover:scale-105 transition-all shadow-lg active:scale-95 shadow-accent/20"
            variant="default"
          >
        ...
        <div className="md:hidden fixed inset-0 bg-background z-[60] overflow-y-auto flex flex-col pt-16 sm:pt-24">
          ...
          <div className="flex flex-col flex-grow bg-background p-6 justify-start pt-24">
              <div className="flex flex-col gap-0.5">
                {isAuthenticated ? (
                  <div className="px-3 py-4 mb-4 bg-accent/5 rounded-2xl border border-accent/20">
                    <p className="text-xs font-bold text-accent  tracking-widest mb-2">Área Personal</p>
                    <button
                      onClick={() => handleNavClick("/dashboard")}
                      className="w-full text-left py-2 text-foreground font-bold text-xl  tracking-tighter flex items-center gap-2"
                    >
                  ...
                  <button
                    ...
                    className="text-left px-3 py-3 rounded-xl text-accent hover:bg-secondary transition-colors font-bold text-xl  tracking-tighter border border-transparent hover:border-accent/20 mb-4"
                  >
                    Área Clientes
                  </button>
                )}
                <button
                  ...
                  className="text-left px-3 py-3 rounded-xl text-foreground hover:bg-secondary transition-colors font-bold text-xl  tracking-tighter border border-transparent hover:border-accent/20"
                >
                  Inicio
                </button>
              <button
              ...
              <button
                ...
                className="text-left px-3 py-3 rounded-xl text-foreground hover:bg-secondary transition-colors font-bold text-xl  tracking-tighter border border-transparent hover:border-accent/20 mb-4"
              >
                Contactanos
              </button>
              <div className="mt-8 px-3 flex flex-col gap-3">
                <Button 
                  ...
                  className="w-full bg-accent text-accent-foreground font-bold text-sm h-12 shadow-lg active:scale-95 transition-transform flex items-center justify-center gap-2 shadow-accent/20"
                >
                  Constituye ahora tu LLC →
                </Button>
                <a 
                ...
                >
                  <Button 
                    className="w-full bg-secondary text-foreground font-bold text-sm h-12 shadow-lg active:scale-95 transition-transform flex items-center justify-center gap-2 border-2 border-accent"
                  >
