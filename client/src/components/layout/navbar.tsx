      ...
      <div className="w-full px-4 sm:px-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <Button 
            ...
            className="hidden md:inline-flex bg-brand-dark text-white font-sans font-medium text-[14px] border-0 rounded-full h-12 px-8 hover:scale-105 transition-all shadow-lg active:scale-95"
          ...
          <div className="flex flex-col flex-grow bg-white p-6 justify-start pt-24">
            <div className="flex flex-col gap-0.5">
              ...
              <div className="mt-8 px-3 flex flex-col gap-3">
                <Button 
                  onClick={() => handleNavClick("/servicios")}
                  className="w-full bg-brand-dark text-white font-sans font-medium h-12 text-base shadow-lg active:scale-95 transition-transform flex items-center justify-center gap-2"
                ...
                >
                  <Button 
                    className="w-full bg-brand-lime text-brand-dark font-sans font-medium h-12 text-base shadow-lg active:scale-95 transition-transform flex items-center justify-center gap-2"
