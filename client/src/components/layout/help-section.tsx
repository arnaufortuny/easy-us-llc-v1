...
export function HelpSection() {
  return (
    <section className="bg-white py-8 md:py-20 border-t border-brand-lime/10 w-full flex justify-center items-center font-sans">
        ...
        >
          <div className="space-y-2 md:space-y-4 w-full text-center">
            <h2 className="text-xl md:text-4xl font-black uppercase tracking-tighter text-brand-dark leading-none text-center">
              ¿ALGUNA <span className="text-brand-dark bg-brand-lime px-2 inline-block">CONSULTA</span>?
            </h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3 md:gap-4 w-full max-w-lg mx-auto">
            <a href="https://wa.me/34614916910" target="_blank" rel="noopener noreferrer" className="w-full">
              <Button 
                className="bg-brand-lime text-brand-dark font-black text-xs md:text-base px-8 border-0 w-full rounded-full h-10 md:h-14 shadow-lg hover:bg-brand-lime/90 active:scale-95 transition-all flex items-center justify-center gap-2 md:gap-3 hover:scale-105"
              >
            ...
            <Link href="/faq" className="w-full">
              <Button 
                variant="outline" 
                className="border-brand-dark text-brand-dark font-black text-xs md:text-base px-8 w-full rounded-full h-10 md:h-14 hover:bg-brand-dark hover:text-white active:scale-95 transition-all tracking-tight"
              >
                FAQ
              </Button>
            </Link>
