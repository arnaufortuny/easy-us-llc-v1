...
export function HelpSection() {
  return (
    <section className="bg-white py-12 md:py-20 border-t border-brand-lime/10 w-full flex justify-center items-center font-sans">
      <div className="container max-w-4xl mx-auto px-5 relative z-10 flex flex-col items-center justify-center">
        ...
        >
          <div className="space-y-4 w-full text-center">
            ...
            <p className="text-brand-dark/60 text-sm md:text-lg font-medium max-w-2xl mx-auto leading-relaxed text-center px-2">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full max-w-lg mx-auto">
            <a href="https://wa.me/34614916910" target="_blank" rel="noopener noreferrer" className="w-full">
              <Button 
                className="bg-brand-lime text-brand-dark font-black text-sm md:text-base px-8 border-0 w-full rounded-full h-12 md:h-14 shadow-lg hover:bg-brand-lime/90 active:scale-95 transition-all flex items-center justify-center gap-3"
              >
