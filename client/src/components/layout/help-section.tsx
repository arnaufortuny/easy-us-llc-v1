        ...
        <div className="text-center space-y-4 md:space-y-8 w-full flex flex-col items-center">
          <div className="space-y-2 md:space-y-4 w-full text-center">
            <h2 className="text-xl md:text-4xl font-black tracking-tighter text-foreground leading-none text-center">
              {t("helpSection.title")} <span className="text-foreground bg-accent px-2 inline-block">{t("helpSection.titleHighlight")}</span>?
            </h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3 md:gap-4 w-full max-w-lg mx-auto">
            <a href="https://wa.me/34614916910?text=Hola!%20Tengo%20una%20consulta%20sobre%20vuestros%20servicios" target="_blank" rel="noopener noreferrer" className="w-full">
              ...
              >
                ...
                {t("helpSection.whatsapp")}
              </Button>
            </a>
            <Link href="/faq" className="w-full">
              <Button 
                variant="outline" 
                className="border-primary text-primary font-black text-xs md:text-base px-8 w-full rounded-full h-10 md:h-14 hover:bg-accent hover:text-primary-foreground tracking-tight"
              >
                FAQ
              </Button>
            </Link>
