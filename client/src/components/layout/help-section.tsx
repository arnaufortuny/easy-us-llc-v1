      ...
      <div className="container max-w-4xl mx-auto px-5 relative z-10 flex flex-col items-center justify-center">
        ...
        >
          <div className="space-y-2 md:space-y-4 w-full text-center">
            <h2 className="text-xl md:text-4xl font-bold  tracking-tighter text-foreground leading-none text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3 md:gap-4 w-full max-w-lg mx-auto">
            <a href="https://wa.me/34614916910" target="_blank" rel="noopener noreferrer" className="w-full">
              <Button 
                className="bg-accent text-accent-foreground font-bold text-xs md:text-base px-8 border-0 w-full rounded-full h-10 md:h-14 shadow-lg hover:bg-accent/90 active:scale-95 transition-all flex items-center justify-center gap-2 md:gap-3 hover:scale-105 shadow-accent/20"
              >
            ...
            <Link href="/faq" className="w-full">
              <Button 
                variant="outline" 
                className="border-primary text-primary font-bold text-xs md:text-base px-8 w-full rounded-full h-10 md:h-14 hover:bg-accent hover:text-primary-foreground active:scale-95 transition-all tracking-tight"
              >
                FAQ
              </Button>
            </Link>
