        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3 md:gap-4 w-full max-w-lg mx-auto">
            ...
            <Link href="/faq" className="w-full">
              <Button 
                variant="outline" 
                className="border-primary text-primary font-black text-xs md:text-base px-8 w-full rounded-full h-10 md:h-14 hover:bg-accent hover:text-primary-foreground active:scale-95 transition-all tracking-tight"
              >
                FAQ
              </Button>
            </Link>
