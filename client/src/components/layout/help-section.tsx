    ...
    <section className="bg-white py-16 sm:py-24 border-t border-brand-lime/10">
      <div className="container max-w-7xl mx-auto px-5 sm:px-8">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full px-4 sm:px-0 max-w-4xl mx-auto">
            <a href="https://wa.me/34614916910" target="_blank" rel="noopener noreferrer" className="w-full">
              <Button 
                size="lg"
                className="bg-brand-lime text-brand-dark font-black text-xl sm:text-2xl px-8 border-0 w-full rounded-full h-16 sm:h-24 shadow-xl hover:bg-brand-lime/90 active:bg-brand-lime transition-all flex items-center justify-center gap-3 group"
              >
