      ...
      <div className="w-full px-4 sm:px-8 max-w-7xl mx-auto">
        ...
        >
          <Link href="/llc/formation">
            <Button 
              className="bg-accent hover:bg-accent/90 text-primary font-black text-base sm:text-lg rounded-full px-10 py-7 h-14 shadow-lg shadow-accent/20 transition-all transform active:scale-95"
          ...
          <Link href="/servicios#comparador">
            <Button 
              variant="outline"
              className="font-black text-base sm:text-lg rounded-full px-10 py-7 h-14 border-2 transition-all transform active:scale-95"
