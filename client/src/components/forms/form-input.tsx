        ...
        <FormItem className={className}>
          ...
          <FormControl>
            <Input
              ...
              disabled={disabled}
              className="rounded-full h-11 md:h-12 px-5 border-2 border-gray-200 dark:border-[#1a3a2a] focus:border-accent bg-white dark:bg-[#112B1E] transition-colors font-medium text-foreground dark:text-white text-base placeholder:text-muted-foreground"
